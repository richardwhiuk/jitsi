 ...
 * <tt>OperationSetPresence</tt> in order to make it easier for
 * implementers to provide complete solutions while focusing on
 * implementation-specific details.
 * 
 * @author Lubomir Marinov
 */
public abstract class AbstractOperationSetPresence<T extends ProtocolProviderService>
    implements OperationSetPresence
{
    /**
    ...
    private static final Logger logger =
        Logger.getLogger(AbstractOperationSetPresence.class);
     ...
     *            the new instance
     */
    protected AbstractOperationSetPresence(T parentProvider)
    {
