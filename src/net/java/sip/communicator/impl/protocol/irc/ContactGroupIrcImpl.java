    ...
    implements ContactGroup
{
     ...
     */
    private ContactGroupIrcImpl parentGroup = null;
     ...
     */
    public void addContact(ContactIrcImpl contactToAdd)
    {
     ...
     */
    public void addSubgroup(ContactGroupIrcImpl subgroup)
    {
     ...
     */
    void setParentGroup(ContactGroupIrcImpl parent)
    {
     ...
     */
    public void removeSubGroup(ContactGroupIrcImpl subgroup)
    {
    ...
    {
        if ( subGroups.contains(ircGroup) )
            return this;

        Iterator<ContactGroup> subGroupsIter = subgroups();
        while (subGroupsIter.hasNext())
        {
            ContactGroupIrcImpl subgroup
                = (ContactGroupIrcImpl) subGroupsIter.next();

            ContactGroupIrcImpl parent
                = subgroup.findGroupParent(ircGroup);
     ...
     */
    public ContactGroupIrcImpl findContactParent(
                                        ContactIrcImpl ircContact)
    {
        if ( contacts.contains(ircContact) )
            return this;
        ...
        while (subGroupsIter.hasNext())
        {
            ...
            ContactGroupIrcImpl parent
                = subgroup.findContactParent(ircContact);
     ...
     */
    public ContactIrcImpl findContactByID(String id)
    {
        ...
        while(contactsIter.hasNext())
        {
            ContactIrcImpl mContact
                = (ContactIrcImpl) contactsIter.next();
        ...
        while( groupsIter.hasNext() )
        {
            ContactGroupIrcImpl mGroup
                = (ContactGroupIrcImpl)groupsIter.next();
            ContactIrcImpl mContact = mGroup.findContactByID(id);
    ...
    {
        if(obj == null
           || !(obj instanceof ContactGroupIrcImpl))
            return false;

        ContactGroupIrcImpl gibberishGroup
            = (ContactGroupIrcImpl)obj;
